...
当然你也可以用真实的图片进行测试, 把clients/目录拷贝到镜像中, 进入clients/目录, 执行如下命令:

```sh
python3 yolov3_client.py
```
...
```
(1, 3, 608, 608)
inference cost 1669.2664623260498 ms
(1, 255, 19, 19)
(1, 255, 38, 38)
(1, 255, 76, 76)
[[135.14840185 219.59885519 184.30208097 324.02638471]
 [ 98.30803862 135.72614938 499.71267209 299.25573075]
 [478.00605894  81.25702863 210.57789777  86.91503174]]
[16  1  7]
[0.99854713 0.99880403 0.93829252]
[[135.14840185 219.59885519 184.30208097 324.02638471]
 [ 98.30803862 135.72614938 499.71267209 299.25573075]
 [478.00605894  81.25702863 210.57789777  86.91503174]] [0.99854713 0.99880403 0.93829252] [16  1  7]
Saved image with bounding boxes of detected objects to output_dog.png.
```
