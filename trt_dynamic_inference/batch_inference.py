...
def get_random_inputs(
    ...
    for binding_index in input_binding_idxs:
        ...
        if is_dynamic(input_shape):
            ...
            profile_shapes[1][0] = profile_shapes[1][0] + 1
            input_shape = profile_shapes[1]
            # input_shape = profile_shapes[0]
            # input_shape = [4, 3, 80, 80]
...
def main():
    ...
    t2 = time.time()
    print("cuda mem alloc cost: {}ms".format((t2-t1)*1000))
    ...
    # View outputs
    print("Inference Outputs:", host_outputs[0])
    # print("Inference Outputs:", host_outputs[1])
